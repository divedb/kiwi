...
\DoxyCodeLine{00238\ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{reinterpret\_cast<}std::error\_code*\textcolor{keyword}{>}(\&error\_storage);}
\DoxyCodeLine{00239\ \ \ \}}
\DoxyCodeLine{00240\ }
\DoxyCodeLine{00241\ \ \ \textcolor{keyword}{const}\ std::error\_code*\ GetErrorStorage()\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00242\ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{const\_cast<}ErrorOr<T>*\textcolor{keyword}{>}(\textcolor{keyword}{this})-\/>GetErrorStorage();}
\DoxyCodeLine{00243\ \ \ \}}
\DoxyCodeLine{00244\ }
\DoxyCodeLine{00245\ \ \ \textcolor{keyword}{union\ }\{}
\DoxyCodeLine{00246\ \ \ \ \ AlignedCharArrayUnion<storage\_type>\ t\_storage;}
\DoxyCodeLine{00247\ \ \ \ \ AlignedCharArrayUnion<std::error\_code>\ error\_storage;}
\DoxyCodeLine{00248\ \ \ \};}
\DoxyCodeLine{00249\ }
\DoxyCodeLine{00250\ \ \ \textcolor{keywordtype}{bool}\ has\_error\_\ :\ 1;}
\DoxyCodeLine{00251\ \};}
\DoxyCodeLine{00252\ }
\DoxyCodeLine{00253\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ \textcolor{keyword}{typename}\ E>}
\DoxyCodeLine{00254\ std::enable\_if\_t<std::is\_error\_code\_enum<E>::value\ ||}
\DoxyCodeLine{00255\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ std::is\_error\_condition\_enum<E>::value,}
\DoxyCodeLine{00256\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{bool}>}
\DoxyCodeLine{00257\ operator==(\textcolor{keyword}{const}\ \mbox{\hyperlink{classchibicpp_1_1_error_or}{ErrorOr<T>}}\&\ err,\ E\ code)\ \{}
\DoxyCodeLine{00258\ \ \ \textcolor{keywordflow}{return}\ err.GetError()\ ==\ code;}
\DoxyCodeLine{00259\ \}}
\DoxyCodeLine{00260\ }
\DoxyCodeLine{00261\ \}\ \ \textcolor{comment}{//\ namespace\ chibicpp}}
