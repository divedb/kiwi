...
\DoxyCodeLine{00080\ \ \ \ \ \textcolor{keywordflow}{if}\ (CheckedAddOp<T,\ U>::Do(x,\ y,\ \&result))\ [[likely]]\ \{}
...
\DoxyCodeLine{00102\ \ \ \ \ \textcolor{keywordflow}{if}\ (CheckedSubOp<T,\ U>::Do(x,\ y,\ \&result))\ [[likely]]\ \{}
...
\DoxyCodeLine{00124\ \ \ \ \ \textcolor{keywordflow}{if}\ (CheckedMulOp<T,\ U>::Do(x,\ y,\ \&result))\ [[likely]]\ \{}
...
\DoxyCodeLine{00141\ \ \ \ \ \textcolor{keywordflow}{if}\ ((CheckedDivOp<T,\ U>::Do(x,\ y,\ \&result)))\ [[likely]]\ \{}
...
\DoxyCodeLine{00160\ \ \ \ \ \textcolor{keywordflow}{if}\ (CheckedModOp<T,\ U>::Do(x,\ y,\ \&result))\ [[likely]]\ \{}
