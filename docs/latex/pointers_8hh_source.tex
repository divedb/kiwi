...
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{keyword}{namespace\ }kiwi\ \{}
\DoxyCodeLine{00029\ }
...
\DoxyCodeLine{00066\ \textcolor{keyword}{using\ }Owner\ =\ T;}
\DoxyCodeLine{00067\ }
...
\DoxyCodeLine{00149\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{dense__map_8hh_a0d27e9ac9b943e14361fe2ba7ec21a46}{operator==}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<T>}}\&\ lhs,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<U>}}\&\ rhs)\ \textcolor{keyword}{noexcept}(}
...
\DoxyCodeLine{00155\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{dense__map_8hh_a008449c6439d3cbc96cc662630b49736}{operator!=}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<T>}}\&\ lhs,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<U>}}\&\ rhs)\ \textcolor{keyword}{noexcept}(}
...
\DoxyCodeLine{00190\ std::ptrdiff\_t\ operator-\/(\textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<T>}}\&,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<U>}}\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00191\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00192\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<T>}}\ operator-\/(\textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_not_null}{NotNull<T>}}\&,\ std::ptrdiff\_t)\ =\ \textcolor{keyword}{delete};}
...
\DoxyCodeLine{00218\ \textcolor{keyword}{struct\ }hash<kiwi::NotNull<T>>\ :\ \mbox{\hyperlink{structkiwi_1_1_not_null_hash}{kiwi::NotNullHash}}<kiwi::NotNull<T>>\ \{\};}
\DoxyCodeLine{00219\ }
\DoxyCodeLine{00220\ \}\ \ \textcolor{comment}{//\ namespace\ std}}
\DoxyCodeLine{00221\ }
\DoxyCodeLine{00222\ \textcolor{keyword}{namespace\ }kiwi\ \{}
\DoxyCodeLine{00223\ }
...
\DoxyCodeLine{00285\ std::ptrdiff\_t\ operator-\/(\textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_strict_not_null}{StrictNotNull<T>}}\&,}
...
\DoxyCodeLine{00288\ \mbox{\hyperlink{classkiwi_1_1_strict_not_null}{StrictNotNull<T>}}\ operator-\/(\textcolor{keyword}{const}\ \mbox{\hyperlink{classkiwi_1_1_strict_not_null}{StrictNotNull<T>}}\&,\ std::ptrdiff\_t)\ =\ \textcolor{keyword}{delete};}
...
\DoxyCodeLine{00314\ \textcolor{keyword}{struct\ }hash<kiwi::StrictNotNull<T>>}
