...
int getsockopt(NetworkSocket s, int level, int optname, void* optval,
               socklen_t* optlen);
...
int sendmmsg(NetworkSocket socket, mmsghdr* msgvec, unsigned int vlen,
             int flags);
int setsockopt(NetworkSocket s, int level, int optname, const void* optval,
               socklen_t optlen);
...
typedef int (*wsa_error_translator_ptr)(NetworkSocket socket, intptr_t api,
                                        intptr_t ret, int wsa_error);
void set_wsa_error_translator(wsa_error_translator_ptr translator,
