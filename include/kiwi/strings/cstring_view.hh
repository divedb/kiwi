...
class basic_cstring_view final {
 ...
 public:
  ...
  PURE_FUNCTION constexpr std::basic_string_view<Char> substr(
      size_t pos, size_t count = npos) const noexcept {
  ...
  template <class Traits, class Alloc>
  friend constexpr std::basic_string<Char, Traits, Alloc> operator+(
      basic_cstring_view lhs, std::basic_string<Char, Traits, Alloc>&& rhs) {
  ...
  template <class Traits, class Alloc>
  friend constexpr std::basic_string<Char, Traits, Alloc> operator+(
      std::basic_string<Char, Traits, Alloc>&& lhs, basic_cstring_view rhs) {
...
std::basic_ostream<Char, Traits>& operator<<(
    std::basic_ostream<Char, Traits>& os, basic_cstring_view<Char> view) {
