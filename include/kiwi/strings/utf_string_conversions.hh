...
BASE_EXPORT bool UTF16ToWide(const char16_t* src, size_t src_len,
                             std::wstring* output);
[[nodiscard]] BASE_EXPORT std::wstring UTF16ToWide(std::u16string_view utf16);

BASE_EXPORT bool UTF8ToUTF16(const char* src, size_t src_len,
                             std::u16string* output);
[[nodiscard]] BASE_EXPORT std::u16string UTF8ToUTF16(std::string_view utf8);
BASE_EXPORT bool UTF16ToUTF8(const char16_t* src, size_t src_len,
                             std::string* output);
