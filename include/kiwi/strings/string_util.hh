...
BASE_EXPORT size_t u16cstrlcpy(char16_t* dst, const char16_t* src,
                               size_t dst_size);
...
BASE_EXPORT bool TrimString(std::u16string_view input,
                            ...
                            std::u16string* output);
BASE_EXPORT bool TrimString(std::string_view input, std::string_view trim_chars,
                            std::string* output);
...
BASE_EXPORT std::u16string CollapseWhitespace(
    std::u16string_view text, bool trim_sequences_with_line_breaks);
...
BASE_EXPORT bool StartsWith(
    std::u16string_view str, std::u16string_view search_for,
    CompareCase case_sensitivity = CompareCase::SENSITIVE);
...
BASE_EXPORT std::optional<std::u16string_view> RemovePrefix(
    std::u16string_view string, std::u16string_view prefix,
    CompareCase case_sensitivity = CompareCase::SENSITIVE);
...
BASE_EXPORT std::optional<std::u16string_view> RemoveSuffix(
    std::u16string_view string, std::u16string_view suffix,
    CompareCase case_sensitivity = CompareCase::SENSITIVE);
...
BASE_EXPORT void ReplaceFirstSubstringAfterOffset(
    std::u16string* str, size_t start_offset, std::u16string_view find_this,
    std::u16string_view replace_with);
BASE_EXPORT void ReplaceFirstSubstringAfterOffset(
...
BASE_EXPORT std::u16string ReplaceStringPlaceholders(
    std::u16string_view format_string, std::u16string_view subst,
    size_t* offset);
