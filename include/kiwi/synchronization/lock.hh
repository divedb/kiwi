...
KIWI_CREATE_MEMBER_INVOKER_SUITE(try_lock_until);
KIWI_CREATE_MEMBER_INVOKER_SUITE(unlock);
KIWI_CREATE_MEMBER_INVOKER_SUITE(lock_shared);
KIWI_CREATE_MEMBER_INVOKER_SUITE(try_lock_shared);
KIWI_CREATE_MEMBER_INVOKER_SUITE(try_lock_shared_for);
KIWI_CREATE_MEMBER_INVOKER_SUITE(try_lock_shared_until);
KIWI_CREATE_MEMBER_INVOKER_SUITE(unlock_shared);
KIWI_CREATE_MEMBER_INVOKER_SUITE(lock_upgrade);
KIWI_CREATE_MEMBER_INVOKER_SUITE(try_lock_upgrade);
KIWI_CREATE_MEMBER_INVOKER_SUITE(try_lock_upgrade_for);
...
template <template <typename> class ToLock, typename Mutex,
...
//  available.
template <template <typename> class ToLock, typename Mutex,
          template <typename> class FromLock, typename Rep, typename Period>
...
//  available.
template <template <typename> class ToLock, typename Mutex,
          template <typename> class FromLock, typename Clock, typename Duration>
