...
#define KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(type)             \
  template <>                                                                \
...
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(char)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(signed char)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(unsigned char)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(signed short)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(unsigned short)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(signed int)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(unsigned int)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(signed long)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(unsigned long)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(signed long long)
KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION(unsigned long long)

#undef KIWI_RELAXED_ATOMIC_DEFINE_INTEGRAL_SPECIALIZATION
