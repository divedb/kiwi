...
#include "kiwi/adt/dense_map_info.hh"
#include "kiwi/util/epoch_tracker.hh"
...
template <typename KeyT, typename ValueT,
          ...
          typename Bucket = kiwi::detail::DenseMapPair<KeyT, ValueT>,
          bool IsConst = false>
...
template <typename KeyT, typename ValueT,
          typename KeyInfoT = DenseMapInfo<KeyT>,
          typename BucketT = kiwi::detail::DenseMapPair<KeyT, ValueT>>
