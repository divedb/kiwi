...
enum class Op { kMove, kNuke, kHeap };
...
template <typename Fun, bool Small, bool Nx, typename ReturnType,
          typename... Args>
...
template <typename P>
struct function_ctor_deduce_<
    std::enable_if_t<std::is_function<std::remove_pointer_t<P>>::value>, P> {
