...
class Codec {
 ...
 protected:
  Codec(CodecType type, folly::Optional<int> level = folly::none,
...
class StreamCodec : public Codec {
 public:
   ...
   */
  bool compressStream(folly::ByteRange& input, folly::MutableByteRange& output,
   ...
   */
  bool uncompressStream(folly::ByteRange& input,
                        folly::MutableByteRange& output,
                        FlushOp flushOp = StreamCodec::FlushOp::NONE);

 protected:
  StreamCodec(CodecType type, folly::Optional<int> level = folly::none,
              folly::StringPiece name = {})
 ...
 private:
  ...
  virtual bool doCompressStream(folly::ByteRange& input,
                                folly::MutableByteRange& output,
                                FlushOp flushOp) = 0;
  virtual bool doUncompressStream(folly::ByteRange& input,
                                  folly::MutableByteRange& output,
                                  FlushOp flushOp) = 0;
