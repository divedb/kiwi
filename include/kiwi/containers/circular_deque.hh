...
#include "kiwi/containers/vector_buffer.hh"
#include "kiwi/numerics/checked_math.hh"
#include "kiwi/numerics/safe_conversions.hh"
#include "kiwi/types/cxx23_from_range.hh"
...
#if DCHECK_IS_ON()
  const circular_deque<T>* parent_deque_ = nullptr;
