...
FOLLY_ERASE void do_op_del_sized_(void* const p, std::size_t const s,
                                  A const... a) {
...
struct operator_new_fn {
  ...
  FOLLY_NODISCARD FOLLY_ERASE void* operator()(  //
      std::size_t const s, std::nothrow_t const& nt) const noexcept {
  ...
  FOLLY_NODISCARD FOLLY_ERASE void* operator()(  //
      std::size_t const s, std::align_val_t const a,
...
struct operator_delete_fn {
  ...
  FOLLY_ERASE void operator()(  //
      void* const p, std::size_t const s) const noexcept {
    return detail::do_op_del_sized_<true>(p, s);
  }
  FOLLY_ERASE void operator()(  //
      void* const p, std::align_val_t const a) const noexcept {
    return detail::op_del_<detail::cpp_aligned_new_>(p, a);
  }
  FOLLY_ERASE void operator()(  //
      void* const p, std::size_t const s,
