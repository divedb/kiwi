...
extern "C" KIWI_KEEP void check_folly_function_move(void* src, void* dst) {
  new (dst) Function<void()>(std::move(*static_cast<Function<void()>*>(src)));
}

extern "C" KIWI_KEEP void check_folly_function_nuke(void* fun) {
  static_cast<Function<void()>*>(fun)->~Function();
}

extern "C" KIWI_KEEP void check_folly_function_move_assign(void* src,
                                                           void* dst) {
...
struct check_invocable_base<false, NxCopy> {
  KIWI_NOINLINE check_invocable_base(check_invocable_base const&) noexcept(
      NxCopy) {}
  void operator=(check_invocable_base const&) = delete;
  KIWI_NOINLINE ~check_invocable_base() {}
};
template <>
...
extern "C" KIWI_KEEP void check_folly_function_make_in_situ_trivial(void* fun,
                                                                    void* obj) {
  constexpr auto size = 6 * sizeof(void*);
  constexpr auto align = kiwi::kMaxAlign;
...
extern "C" KIWI_KEEP void check_folly_function_make_in_situ_default(void* fun,
                                                                    void* obj) {
  constexpr auto size = 6 * sizeof(void*);
  constexpr auto align = kiwi::kMaxAlign;
...
extern "C" KIWI_KEEP void check_folly_function_make_on_heap_trivial(void* fun,
                                                                    void* obj) {
...
extern "C" KIWI_KEEP void check_folly_function_make_on_heap_default(void* fun,
                                                                    void* obj) {
  constexpr auto size = 12 * sizeof(void*);
  constexpr auto align = kiwi::kMaxAlign;
  using inv_t = check_invocable<false, true, size, align>;
...
namespace {
int func_int_int_add_25(int x) { return x + 25; }
int func_int_int_add_111(int x) { return x + 111; }
...
static_assert(
    ...
    "");
static_assert(!std::is_constructible<Function<void() const>,
                                     CallableButNotCopyable>::value,
              "");
static_assert(!std::is_constructible<Function<void() const>,
                                     CallableButNotCopyable&>::value,
              "");
...
static_assert(
    ...
    "");
static_assert(std::is_constructible<Function<int(short)>,
                                    Function<short(int) const>>::value,
              "");
static_assert(!std::is_constructible<Function<int(short) const>,
                                     Function<short(int)>>::value,
              "");
static_assert(!std::is_constructible<Function<int(int)>,
                                     Function<int(int) const>&>::value,
              "");
static_assert(!std::is_constructible<Function<int(int) const>,
...
static_assert(
    ...
    "");
static_assert(!std::is_assignable<Function<int(short) const>,
                                  Function<short(int)>>::value,
              "");
static_assert(
    !std::is_assignable<Function<int(int)>, Function<int(int) const>&>::value,
...
static_assert(
    !std::is_assignable<Function<int(int) const>, Function<int(int)>&>::value,
    "");
static_assert(!std::is_assignable<Function<int(short)>,
                                  Function<short(int) const>&>::value,
              "");
static_assert(!std::is_assignable<Function<int(short) const>,
                                  Function<short(int)>&>::value,
...
static_assert(std::is_nothrow_constructible<Function<int(int)>,
                                            Function<int(int) const>>::value,
              "");
static_assert(!std::is_nothrow_constructible<Function<int(short)>,
                                             Function<short(int) const>>::value,
              "");
static_assert(std::is_nothrow_assignable<Function<int(int)>,
                                         Function<int(int) const>>::value,
              "");
static_assert(!std::is_nothrow_assignable<Function<int(short)>,
                                          Function<short(int) const>>::value,
              "");
...
static_assert(                 //
    !std::is_constructible_v<  //
        Function<int() noexcept>, int (*)()>);

static_assert(                 //
    !std::is_constructible_v<  //
        Function<int() const noexcept>, int (*)()>);

static_assert(                //
    std::is_constructible_v<  //
        Function<int() noexcept>, int (*)() noexcept>);

static_assert(                //
    std::is_constructible_v<  //
        Function<int() const noexcept>, int (*)() noexcept>);
...
static_assert(                 //
    !std::is_constructible_v<  //
        Function<int const&() const noexcept>, int (*)()>);

static_assert(                 //
    !std::is_constructible_v<  //
        Function<int() noexcept>, Function<int()>>);

static_assert(                 //
    !std::is_constructible_v<  //
        Function<int() const noexcept>, Function<int() const>>);

static_assert(                //
    std::is_constructible_v<  //
        Function<int()>, Function<int() noexcept>>);

static_assert(                //
    std::is_constructible_v<  //
        Function<int() const>, Function<int() const noexcept>>);
...
static_assert(       //
    std::is_same_v<  //
        Function<void()>, decltype(Function{ctor_guide::fn})>);
static_assert(       //
    std::is_same_v<  //
        Function<void()>, decltype(Function{&ctor_guide::fn})>);
static_assert(       //
    std::is_same_v<  //
        Function<void()>, decltype(Function{ctor_guide::call{}})>);
static_assert(       //
    std::is_same_v<  //
        Function<void() const>, decltype(Function{ctor_guide::call_c{}})>);
static_assert(       //
    std::is_same_v<  //
        Function<void() noexcept>, decltype(Function{ctor_guide::fn_nx})>);
static_assert(       //
    std::is_same_v<  //
        Function<void() noexcept>, decltype(Function{&ctor_guide::fn_nx})>);
static_assert(       //
    std::is_same_v<  //
        Function<void() noexcept>, decltype(Function{ctor_guide::call_nx{}})>);
static_assert(       //
    std::is_same_v<  //
...
struct RecFolly {
  using type = kiwi::Function<RecFolly()>;
...
TEST(Function, InvokeFunctor) {
  ...
  static_assert(sizeof(func) > sizeof(Function<int(size_t)>),
...
TEST(Function, SwapMethod) { swap_test<true>(); }
TEST(Function, SwapFunction) { swap_test<false>(); }
...
TEST(Function, OverloadedFunctor) {
  ...
  // calling the kiwi::const_cast_function which moves it into a
  // Function<R(Args...)const>), the Function must still execute
  // the initially selected function.

  auto variant1_const = kiwi::const_cast_function(std::move(variant1));
  ...
  auto variant3_const = kiwi::const_cast_function(std::move(variant3));
  ...
  auto variant5_const = kiwi::const_cast_function(std::move(variant5));
  EXPECT_THROW(variant5(0, ""), std::bad_function_call);
  EXPECT_EQ(100 + 5 * 26, variant5_const(26, "foo"));

  auto variant6_const = kiwi::const_cast_function(std::move(variant6));
...
TEST(Function, Lambda) {
  ...
  Function<int(int) const> func_made_const =
      kiwi::const_cast_function(std::move(func));
  ...
  Function<int() const> func_mutable_made_const =
      kiwi::const_cast_function(std::move(func_mutable));
...
TEST(Function, IgnoreReturnValue) {
  ...
  // Assign a lambda that return int to a kiwi::Function that returns void.
...
TEST(Function, asStdFunctionArgs) {
  int i = 0;
  kiwi::Function<void(int, int)> f = [&](int x, int y) {
    ++i;
    return x + y;
  };
  auto sf = std::move(f).asStdFunction();
...
TEST(Function, asStdFunctionArgsConst) {
  int i = 0;
  kiwi::Function<void(int, int) const> f = [&](int x, int y) {
    ++i;
    return x + y;
  };
  auto sf = std::move(f).asStdFunction();
...
TEST(Function, asSharedProxyVoidConst) {
  int i = 0;
  kiwi::Function<void() const> f = [&i] { ++i; };
  auto sp = std::move(f).asSharedProxy();
  auto spcopy = sp;
  sp();
  EXPECT_EQ(1, i);
...
TEST(Function, asSharedProxyReturn) {
  kiwi::Function<int()> f = [i = 0]() mutable {
    ++i;
    return i;
  };
  auto sp = std::move(f).asSharedProxy();
...
TEST(Function, asSharedProxyArgs) {
  int i = 0;
  kiwi::Function<int(int, int)> f = [&](int x, int y) mutable {
    ++i;
    return x + y * 2;
  };
  auto sp = std::move(f).asSharedProxy();
...
TEST(Function, asSharedProxyArgsConst) {
  int i = 0;
  kiwi::Function<int(int, int) const> f = [&i](int x, int y) {
    ++i;
    return x * 100 + y * 10 + i;
  };
  auto sp = std::move(f).asSharedProxy();
...
TEST(Function, asSharedProxyForwarding) {
  kiwi::Function<decltype(badCopierF)> ff(badCopierF);
  EXPECT_TRUE(
      (std::is_same_v<decltype(ff),
                      kiwi::Function<std::array<int, 3>(
...
TEST(Function, EmptyAfterConstCast) {
  ...
  Function<int(size_t) const> func2 = const_cast_function(std::move(func));
  EXPECT_FALSE(func2);
}
...
TEST(Function, BugT23346238) { const Function<void()> nullfun; }

TEST(Function, MaxAlignCallable) {
  using A = kiwi::aligned_storage_for_t<kiwi::MaxAlignType>;
...
TEST(Function, ConstInitEmpty) {
  static KIWI_CONSTINIT Function<int()> func;
  EXPECT_THROW(func(), std::bad_function_call);
}

TEST(Function, ConstInitNullptr) {
  static KIWI_CONSTINIT Function<int()> func{nullptr};
  EXPECT_THROW(func(), std::bad_function_call);
}

TEST(Function, ConstInitStaticLambda) {
  static KIWI_CONSTINIT Function<int()> func{[] { return 3; }};
  EXPECT_EQ(3, func());
}
...
union consteval_immortal {
  T value;
  template <typename... A>
  explicit KIWI_CONSTEVAL consteval_immortal(std::in_place_t, A&&... a)
...
TEST(Function, ConstEvalEmpty) {
  static KIWI_CONSTINIT consteval_immortal<Function<int()>> func{std::in_place};
...
TEST(Function, ConstEvalStaticLambda) {
  static KIWI_CONSTINIT consteval_immortal<Function<int()>> func{
