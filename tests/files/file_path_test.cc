...
#include
"third_party/perfetto/include/perfetto/test/traced_value_test_support.h"  //
no-presubmit-check nogncheck #endif  // BUILDFLAG(ENABLE_BASE_TRACING)
*/
...
INSTANTIATE_TEST_SUITE_P(
    FilePathUTF8TestCases, FilePathUTF8Test,
...
INSTANTIATE_TEST_SUITE_P(
    FilePathUTF8InvalidTestCases, FilePathUTF8InvalidTest,
    ::testing::Values(
        // Invalid encoding of U+1FFFE (0x8F instead of 0x9F)
        "\xF0\x8F\xBF\xBE",

        // Surrogate code points
        "\xED\xA0\x80\xED\xBF\xBF", "\xED\xA0\x8F", "\xED\xBF\xBF",
