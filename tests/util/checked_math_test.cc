...
extern "C" FOLLY_KEEP int64_t check_folly_checked_add_int64(int64_t a,
                                                            int64_t b) {
  return check_folly_checked_add_(a, b);
}

extern "C" FOLLY_KEEP uint64_t check_folly_checked_add_uint64(uint64_t a,
                                                              uint64_t b) {
  return check_folly_checked_add_(a, b);
}
...
TEST(CheckedMath, genericCheckedMulUint64TOverflow1) {
  ...
  EXPECT_FALSE(folly::detail::generic_checked_mul<uint64_t>(&a, 0x1'0000'0000,
                                                            0x1'0000'0000));
  EXPECT_EQ(a, {});
}
...
TEST(CheckedMath, genericCheckedMulUint64TOverflow2) {
  ...
  EXPECT_FALSE(folly::detail::generic_checked_mul<uint64_t>(&a, 0xFFFF'FFFF,
                                                            0xF'0000'0000));
  EXPECT_EQ(a, {});
}
...
TEST(CheckedMath, genericCheckedMulUint64TOverflow3) {
  ...
  EXPECT_FALSE(folly::detail::generic_checked_mul<uint64_t>(&a, 0xF'0000'0000,
                                                            0xFFFF'FFFF));
  EXPECT_EQ(a, {});
}
...
TEST(CheckedMath, genericCheckedMulUint64TOverflow4) {
  ...
  EXPECT_FALSE(folly::detail::generic_checked_mul<uint64_t>(&a, 0x2'7FFF'FFFF,
                                                            0x2'7FFF'FFFF));
  EXPECT_EQ(a, {});
}
...
TEST(CheckedMath, genericCheckedMulUint64TOverflow5) {
  ...
  EXPECT_FALSE(folly::detail::generic_checked_mul<uint64_t>(&a, 0x2'0000'0203,
                                                            0x7FFF'FFFF));
  EXPECT_EQ(a, {});
}
...
TEST(CheckedMath, checkedMuladdOverflow2) {
  ...
  EXPECT_FALSE(folly::checked_muladd(&a, 5u, 4u,
...
TEST(CheckedMath, checkedPtrAddOverflow) {
  ...
  EXPECT_FALSE(folly::checked_add(&a, &buf[0],
